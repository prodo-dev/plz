...
class TestKill(unittest.TestCase):
    ...
    def test_do_not_kill_exited(self):
        ...
        while execution_listing_status != 'exited':
            execution_listing_status = get_execution_listing_status(
                context.configuration.user, context.controller,
                finished_execution_id)
            time.sleep(0.1)
    ...
    def test_kill_fail_because_of_ownership(self):
        ...
        self._assert_and_cleanup_instances(context.controller, first_user,
                                           {execution_id})
    ...
    def test_kill_all_kills_only_user(self):
        ...
        self._assert_running_executions(context.controller, second_user,
                                        {second_user_execution_id})

        context.controller.kill_instances(user=second_user,
                                          ignore_ownership=False,
                                          instance_ids=None,
                                          including_idle=None,
                                          force_if_not_idle=True)
        ...
        self._assert_running_executions(context.controller, first_user,
                                        {first_user_execution_id})
    ...
    def _assert_running_executions(self,
