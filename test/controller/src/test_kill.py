...
class TestKill(unittest.TestCase):
    ...
    def test_kill_all(self):
        context, execution_id1 = run_example('common',
                                             'run_forever',
                                             is_end_to_end_path=False)
        context, execution_id2 = run_example('common',
                                             'run_forever',
                                             context=context,
                                             is_end_to_end_path=False)
        ...
        self._assert_running_executions(
            context.controller,
            context.configuration.user, {execution_id1, execution_id2})
    ...
    def test_kill_fail_because_non_idle(self):
        context, execution_id = run_example('common',
                                            'run_forever',
                                            is_end_to_end_path=False)
        ...
        self._assert_and_cleanup_instances(
            context.controller, context.configuration.user, {execution_id})

    def test_do_not_kill_exited(self):
        context, finished_execution_id = run_example('logs',
                                                     'simple',
                                                     is_end_to_end_path=True)

        infos = self._assert_running_executions(
            context.controller,
            context.configuration.user, {finished_execution_id})
    ...
    def test_kill_single_instance(self):
        ...
        self._assert_and_cleanup_instances(
            context.controller, context.configuration.user, {execution_id2})
    ...
    def test_kill_all_kills_only_user(self):
        ...
        self._assert_running_executions(
            context.controller,
            context.configuration.user, {first_user_execution_id})
        ...
        self._assert_running_executions(
            context.controller, second_user, {second_user_execution_id})
        ...
        self._assert_running_executions(
            context.controller, second_user, execution_ids=set())
