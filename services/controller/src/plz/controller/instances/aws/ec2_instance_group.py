...
class EC2InstanceGroup(InstanceProvider):
    ...
    def __init__(self,
                 ...
                 worker_security_group_names: List[str],
                 use_public_dns: bool,
    ...
    def _start_container_in_instance(self,
                                     execution_id: str,
                                     execution_spec: dict,
                                     input_stream: Optional[io.BytesIO],
    ...
    def _make_earmarked_instance_from_data(self,
                                           execution_id: str,
                                           instance_data: dict,
        ...
        if dns_name != '':
            ...
            try:
                ...
                log.info(e)
                yield _msg('instance taken while waiting')
                instance_data = None
                instance = None
            if not is_instance_newly_created:
    ...
    def _ec2_instance_from_instance_data(self,
        ...
        return EC2Instance(self.client,
                           images,
                           containers,
                           volumes,
